...
Локальные student-учетки в Cyber Deploy Hub должны использоваться только для диагностики; в рабочем контуре оставьте `AUTH_LOCAL_STUDENT_LOGIN_ENABLED=false`.
